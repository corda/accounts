...
class LoanBookTradingTests {
    ...
    fun `should transfer freshly created loanbook to account on same node`() {
        ...
        val moveFuture = a.startFlow(MoveLoanBookToNewAccount(createdAccount.state.data.accountId, miningResult, listOf()))
        network.runNetwork()
    ...
    fun `should transfer freshly created loanbook to account on different node`() {
        ...
        val moveFuture = b.startFlow(MoveLoanBookToNewAccount(createdAccountOnA.state.data.accountId, minedGoldBrickOnB, listOf()))
        network.runNetwork()
    ...
    fun `should transfer already owned loanbook to account on same node`() {
        ...
        val moveToNewAccountOnAFuture = a.startFlow(MoveLoanBookToNewAccount(newAccountOnA.state.data.accountId, resultOfMoveOnB, listOf()))
        network.runNetwork()
    ...
    fun `should transfer already owned loanbook to account on different node`() {
        ...
        val moveToNewAccountOnAFuture = a.startFlow(MoveLoanBookToNewAccount(newAccountOnA.state.data.accountId, resultOfMoveToAccountOnA, listOf()))
        network.runNetwork()
        ...
        val moveToAccountOnCFuture = a.startFlow(MoveLoanBookToNewAccount(createdAccountOnC.state.data.accountId, movedToNewAccountOnABrick, listOf()))
        network.runNetwork()
