...
class TestUtils {
    ...
    companion object {
        ...
        val REQUIRED_CORDAPP_PACKAGES = listOf(
                TestCordapp.findCordapp("com.r3.corda.lib.accounts.examples.sweepstake.states"),
                TestCordapp.findCordapp("com.r3.corda.lib.accounts.examples.sweepstake.contracts"),
                TestCordapp.findCordapp("com.r3.corda.lib.accounts.examples.sweepstake.flows"),
                TestCordapp.findCordapp("com.r3.corda.lib.accounts.examples.sweepstake.service"),
