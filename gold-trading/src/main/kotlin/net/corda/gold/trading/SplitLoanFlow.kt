...
@StartableByRPC
class SplitLoanFlow(private val oldLoanBook: StateAndRef<LoanBook>, private val amountToSplitOff: Long) : FlowLogic<List<StateAndRef<LoanBook>>>() {
    ...
    override fun call(): List<StateAndRef<LoanBook>> {
        ...
        val account =
            accountService.accountInfo(oldLoanBook.state.data.owningAccount!!) ?: throw IllegalStateException("Attempting to split a loan owned by an account we do not know about")
